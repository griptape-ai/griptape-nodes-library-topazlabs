    ...
    async def _process_async(self) -> None:
        ...
        try:
            ...
            if model == "Redefine":
                ...
                print("DEBUG NODE: Raw parameter values:")
                ...
                print("DEBUG NODE: Converted parameter values:")
            ...
            with self._get_topaz_client() as client:
                processed_image_data = client.enhance_gen(image_data=image_data, **api_params)

            # Save output image
            output_artifact = self._save_image_output(
                processed_image_data, f"enhance_generative_{model.lower().replace(' ', '_')}"
            )
