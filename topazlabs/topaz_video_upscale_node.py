...
class TopazVideoUpscaleNode(BaseTopazVideoNode):
    ...
    def _calculate_output_resolution(self, source_resolution: dict[str, int]) -> dict[str, int]:
        ...
        return {"width": source_resolution["width"] * multiplier, "height": source_resolution["height"] * multiplier}
    ...
    async def _process_async(self) -> None:
        ...
        try:
            ...
            # Save output video
            output_artifact = self._save_video_output(processed_video_bytes, f"upscaled_{model}_{upscale_factor}")
